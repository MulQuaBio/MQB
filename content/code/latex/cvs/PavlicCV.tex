...
%% was not available when you ran la-te-x on this source. Simply rErUN  %%
%% la-te-x to get the ``??'' replaced with the number of the last page  %%
%% of the document. The AUX file will be generated on the first run   %%
%% of la-te-x and used on the second run to fill in all of the          %%
%% references.                                                        %%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
% This also tells la-te-x to preferably break a page on one of these gaps
...
% Custom hyphenation rules for words that la-te-x has trouble with
...
\begin{innerlist}
    \item \href{http://vim-latex.sourceforge.net/}{Vim-la-te-x} suite
...
%
\begin{innerlist}
    \item \TeX{} (\la-te-x{}, \BibTeX{}, PSTricks), Vim,
...
% redistribution of this la-te-x source code; it also includes a liability

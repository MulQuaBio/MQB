...
tool for combining both \la-te-x\ documentation and r code within the
...
generate textual/graphical output, and also creates a \la-te-x\ document.
The \la-te-x\ document is then typeset to create the pdf document.  On
